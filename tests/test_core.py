...
class TestScoutCore(unittest.TestCase):
    ...
    def test_argument_parser(self):
        ...
        assert (test_arguments.subparsers._choices_actions[
                    0].help == 'Run Scout against an Amazon Web Services account')
        assert (test_arguments.subparsers._choices_actions[
                    1].help == 'Run Scout against a Google Cloud Platform account')
        ...
        assert (test_arguments.subparsers._choices_actions[
                    4].help == 'Run Scout against an Oracle Cloud Infrastructure account')
    ...
    def test_prompt_value(self):
        ...
        assert (prompt_value(question='', max_laps=1, test_input='test', is_question=True, choices=['test'],
                             no_confirm=True) == 'test')
