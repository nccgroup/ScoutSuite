 ...
 * @param {*} service
 */
export const getExternalAttachService = (service) =>
 ...
 * @param {*} service
 */
export const getPasswordPolicy = (service) =>
 ...
 * @param {*} finding
 */
export const getItems = (service, finding) =>
  `${getFindings(service)}/${finding}/items`;
 ...
 * @returns 
 */
export const getResources = (service, resource) =>
