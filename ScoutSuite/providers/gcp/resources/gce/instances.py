...
class Instances(GCPCompositeResources):
    ...
    def _parse_instance(self, raw_instance):
        ...
        instance_dict[
            "block_project_ssh_keys_enabled"
    ...
    def _is_oslogin_enabled(self, raw_instance):
        ...
        project_logging_enabled = raw_instance["commonInstanceMetadata"].get(
            "enable-oslogin"
        )
        return (
            instance_logging_enabled == "TRUE"
            or instance_logging_enabled is None
            and project_logging_enabled == "TRUE"
        )
