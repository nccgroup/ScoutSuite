...
class Subnetworks(Resources):
    ...
    async def fetch_all(self):
        raw_subnetworks = await self.facade.gce.get_subnetworks(
    ...
    def _parse_subnetwork(self, raw_subnetwork):
        ...
        subnetwork_dict["name"] = "%s-%s" % (
            raw_subnetwork["name"],
            subnetwork_dict["region"],
        )
        ...
        subnetwork_dict["private_ip_google_access"] = raw_subnetwork[
