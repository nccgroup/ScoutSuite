...
class IAMConfig(GCPBaseConfig):
    ...
    def _get_service_account_keys(self, api_client, project_id, service_account_email):
        ...
        try:
            ...
            print_exception('Failed to get keys for service account %s: %s' % (service_account_email, e))
            return None
    ...
    def _get_service_account_iam_policy(self, api_client, project_id, service_account_email):
        ...
        try:
            ...
            print_exception('Failed to get IAM policy for service account %s: %s' % (service_account_email, e))
            return None
