...
class SecurityCenterConfig(AzureBaseConfig):
    ...
    def parse_security_contacts(self, security_contact, params):
        ...
        security_contact_dict['alert_notifications'] = security_contact.alert_notifications
        security_contact_dict['alerts_to_admins'] = security_contact.alerts_to_admins
