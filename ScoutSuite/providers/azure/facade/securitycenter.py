...
class SecurityCenterFacade:
    ...
    async def get_pricings(self, subscription_id: str):
        try:
            ...
            return await run_concurrently(lambda: client.pricings.list().value)
    ...
    async def get_auto_provisioning_settings(self, subscription_id: str):
        try:
            ...
            print_exception(
                "Failed to retrieve auto provisioning settings: {}".format(e)
            )
            return []
    ...
    async def get_information_protection_policies(self, subscription_id: str):
        try:
            ...
            return await run_concurrently(
                lambda: list(client.information_protection_policies.list(scope=scope))
            )
        except Exception as e:
            print_exception(
                "Failed to retrieve information protection policies: {}".format(e)
            )
            return []
