...
class Applications(AzureResources):
    ...
    async def _parse_application(self, raw_application):
        ...
        ] = raw_application.additional_properties
        ...
        ] = raw_application.allow_passthrough_users
        ...
        ] = raw_application.available_to_other_tenants
        application_dict["error_url"] = raw_application.error_url
        application_dict[
            "group_membership_claims"
        ] = raw_application.group_membership_claims
        ...
        ] = raw_application.pre_authorized_applications
        ...
        ] = raw_application.required_resource_access
