...
class InformationProtectionPolicies(AzureResources):
    ...
    async def fetch_all(self):
        ...
        ) in await self.facade.securitycenter.get_information_protection_policies(
            self.subscription_id
        ):
            (
                id,
                information_protection_policies,
            ) = self._parse_information_protection_policies(raw_information_policies)
    ...
    def _parse_information_protection_policies(self, auto_provisioning_settings):
        ...
        return (
            information_protection_policies_dict["id"],
            information_protection_policies_dict,
        )
