...
class SecurityContacts(AzureResources):
    ...
    def _parse_security_contact(self, security_contact):
        ...
        security_contact_dict["alert_notifications"] = (
            security_contact.alert_notifications == "On"
        )
        security_contact_dict["alerts_to_admins"] = (
            security_contact.alerts_to_admins == "On"
        )
        security_contact_dict[
            "additional_properties"
        ] = security_contact.additional_properties
