...
class NetworkInterfaces(AzureResources):
    ...
    def _parse_network_interface(self, raw_network_interface):
        ...
        ] = raw_network_interface.enable_accelerated_networking
        network_interface_dict["virtual_machine"] = (
            get_non_provider_id(raw_network_interface.virtual_machine.id.lower())
            if raw_network_interface.virtual_machine
            else None
        )
        network_interface_dict["name"] = raw_network_interface.name
        network_interface_dict["tags"] = raw_network_interface.tags
        network_interface_dict["interface_endpoint"] = (
            raw_network_interface.interface_endpoint
            if hasattr(raw_network_interface, "interface_endpoint")
            else None
        )
        ...
        ] = raw_network_interface.additional_properties
        ...
        network_interface_dict[
            "provisioning_state"
        ] = raw_network_interface.provisioning_state
        network_interface_dict["resource_guid"] = raw_network_interface.resource_guid
        network_interface_dict[
            "enable_ip_forwarding"
        ] = raw_network_interface.enable_ip_forwarding
        network_interface_dict["type"] = raw_network_interface.type
        network_interface_dict["network_security_group"] = (
            get_non_provider_id(raw_network_interface.network_security_group.id)
            if raw_network_interface.network_security_group
            else None
        )
        ...
        network_interface_dict[
            "hosted_workloads"
        ] = raw_network_interface.hosted_workloads
        network_interface_dict[
            "tap_configurations"
        ] = raw_network_interface.tap_configurations
        ...
        ip_configuration = raw_network_interface.ip_configurations[
            0
        ]  # TODO is this always an array of 1?
        network_interface_dict["ip_configuration"] = {}
        network_interface_dict["ip_configuration"]["id"] = ip_configuration.id
        network_interface_dict["ip_configuration"][
            "additional_properties"
        ] = ip_configuration.additional_properties
        network_interface_dict["ip_configuration"][
            "virtual_network_taps"
        ] = ip_configuration.virtual_network_taps
        network_interface_dict["ip_configuration"][
            "application_gateway_backend_address_pools"
        ] = ip_configuration.application_gateway_backend_address_pools
        network_interface_dict["ip_configuration"][
            "load_balancer_backend_address_pools"
        ] = ip_configuration.load_balancer_backend_address_pools
        network_interface_dict["ip_configuration"][
            "load_balancer_inbound_nat_rules"
        ] = ip_configuration.load_balancer_inbound_nat_rules
        network_interface_dict["ip_configuration"][
            "private_ip_address"
        ...
        network_interface_dict["ip_configuration"][
            "provisioning_state"
        ] = ip_configuration.provisioning_state
        ...
        if ip_configuration.application_security_groups:
            for asg in ip_configuration.application_security_groups:
                ...
                ].append(get_non_provider_id(asg.id))
