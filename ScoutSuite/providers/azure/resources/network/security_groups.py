...
class SecurityGroups(AzureResources):
    ...
    def _parse_network_security_group(self, network_security_group):
        ...
        if network_security_group.tags is not None:
            network_security_group_dict['tags'] = ["{}:{}".format(key, value)
    ...
    def _parse_security_rule(self, rule, default=False):
        ...
        security_rule_dict['source_port_ranges'] = self._merge_prefixes_or_ports(
            rule.source_port_range, rule.source_port_ranges)
        security_rule_dict['source_ports'] = [
            '0-65535'] if '*' in security_rule_dict['source_port_ranges'] else security_rule_dict['source_port_ranges']
        ...
        security_rule_dict['destination_port_ranges'] = self._merge_prefixes_or_ports(
            rule.destination_port_range, rule.destination_port_ranges)
        security_rule_dict['destination_ports'] = [
            '0-65535'] if '*' in security_rule_dict['destination_port_ranges'] else security_rule_dict['destination_port_ranges']
