...
class DiagnosticSettings(AzureCompositeResources):
    ...
    async def fetch_all(self):
        for diagnostic_setting in await self.facade.loggingmonitoring.get_subscription_diagnostic_settings(self.subscription_id):
