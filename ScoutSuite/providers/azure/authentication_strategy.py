        ...
        **kargs
        ...
        try:
            ...
            if cli:
                ...
                graph_credentials = UserPassCredentials(
                ...
                print_info(
                    "To authenticate to the Resource Manager API, use a web browser to "
                    "access {} and enter the {} code.".format(
                ...
                code = context.acquire_user_code(resource_uri, client_id)
                print_info(
                    "To authenticate to the Azure Graph API, use a web browser to "
                    "access {} and enter the {} code.".format(
                        code["verification_url"], code["user_code"]
                    )
                )
                ...
                graph_credentials = MSIAuthentication(
                    resource="https://graph.windows.net"
                )
            ...
            return AzureCredentials(
                arm_credentials, graph_credentials, tenant_id, subscription_id
            )
