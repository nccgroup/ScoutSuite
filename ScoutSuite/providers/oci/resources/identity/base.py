...
from ScoutSuite.providers.oci.resources.identity.authentication_policy import (
    PasswordPolicy,
)
    ...
    def _match_users_and_groups(self):
        ...
        for user in self["users"]:
            ...
            for group in self["groups"]:
                if any(
                    u["user_identifier"] == self["users"][user]["identifier"]
                    for u in self["groups"][group]["users"]
                ):
