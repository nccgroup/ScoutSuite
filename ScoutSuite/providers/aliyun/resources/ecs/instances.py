...
class Instances(AliyunResources):
    ...
    async def _parse_instance(self, raw_instance):
        ...
        instance_dict["dedicated_instance_attribute"] = raw_instance.get(
        ...
        instance_dict["internet_max_bandwidth_out"] = raw_instance.get(
        ...
        instance_dict["ecs_capacity_reservation_attr"] = raw_instance.get(
        ...
        instance_dict["internet_max_bandwidth_in"] = raw_instance.get(
        ...
        instance_dict["dedicated_host_attribute"] = raw_instance.get(
