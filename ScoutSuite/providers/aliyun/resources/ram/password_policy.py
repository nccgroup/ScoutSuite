...
class PasswordPolicy(AliyunResources):
    ...
    def _parse_password_policy(self, raw_password_policy):
        password_policy_dict = {
            ...
            "password_reuse_prevention": raw_password_policy.get(
                "PasswordReusePrevention"
            ),
            "require_uppercase_characters": raw_password_policy.get(
                "RequireUppercaseCharacters"
            ),
            "require_lowercase_characters": raw_password_policy.get(
        ...
        if password_policy_dict["password_reuse_prevention"] == 0:
            ...
            password_policy_dict["password_reuse_count"] = raw_password_policy.get(
                "PasswordReusePrevention"
            )
