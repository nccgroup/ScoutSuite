"""This module provides implementations for Resources and CompositeResources for OS."""

import abc
from ScoutSuite.providers.base.resources.base import Resources, CompositeResources


class OpenstackResources(Resources, metaclass=abc.ABCMeta):
    """This is the base class for Openstack resources."""

    pass


class OpenstackCompositeResources(OpenstackResources, CompositeResources, metaclass=abc.ABCMeta):
    """This class represents a collection of composite Resources (resources that include nested resources referred as
    their children). Classes extending OpenstackCompositeResources have to define a '_children' attribute which consists of
